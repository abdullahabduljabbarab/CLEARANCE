                                                      ...
                                                      public IIsdkIPointable
{
 ...
 public:
  ...
  /**
   * @return If the grabbable component is sticky and can't be normally released by letting go
   */
  UFUNCTION(BlueprintPure, Category = InteractionSDK)
  bool IsSticky() const { return bIsSticky; }
 ...
 protected:
  ...
  /**
   * The name of the primitive component to use as the grab collider. Only valid if
   * ColliderMode is set to FindByName.
   */
  ...
  /**
   * If true then this grabbable will not be released when the grab is released by normal means
   */
