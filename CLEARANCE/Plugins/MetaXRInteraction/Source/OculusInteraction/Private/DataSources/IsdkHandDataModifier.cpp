    ...
    FActorComponentTickFunction* ThisTickFunction)
{
  ...
  if (bUpdateInTick)
  {
    ...
    isdk::api::IHandDataModifier* const ApiHandDataModifier = GetApiIHandDataModifier();
    if (ApiHandDataModifier)
    {
      ModifiedRootPose = StructTypesUtils::ConvertTransform(ApiHandDataModifier->getRootPose());
    }
  }
}
...
void UIsdkHandDataModifier::SetInputDataSource(UIsdkHandDataSource* InInputDataSource)
{
  ...
  {
    isdk_IHandDataSource* FromDataSource = nullptr;
...
bool UIsdkHandDataModifier::TryGetApiFromDataSource(isdk_IHandDataSource*& OutFromDataSource) const
{
  if (IsValid(InputDataSource))
  {
    isdk::api::IHandDataSource* const ApiFromDataSource = ValidateAndGetApiDataSource(
        InputDataSource, TEXT("UIsdkHandDataModifier::InputDataSource"));
