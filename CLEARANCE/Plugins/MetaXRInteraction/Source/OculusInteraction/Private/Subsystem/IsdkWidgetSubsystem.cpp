...
void UIsdkWidgetSubsystem::RegisterVirtualUserInfo(
    UObject* Interactor,
    const FIsdkVirtualUserInfo& VirtualUserInfo)
{
...
const FIsdkVirtualUserInfo& UIsdkWidgetSubsystem::GetVirtualUserInfo(UObject* Interactor) const
{
  checkf(
...
void UIsdkWidgetSubsystem::DestroyInteractorVirtualUserState(const UObject* Interactor)
{
...
ECollisionChannel UIsdkWidgetSubsystem::GetDefaultCollisionChannel() const
{
  // TODO: retrieve from a config file
  return ECC_GameTraceChannel2; // IsdkCollision
}

ECollisionChannel UIsdkWidgetSubsystem::GetDefaultHoverChannel() const
{
  // TODO: retrieve from a config file
  return ECC_GameTraceChannel3; // IsdkHover
}

bool UIsdkWidgetSubsystem::IsDebugDrawEnabled() const
{
  // TODO: drive this by a configuration
  return true;
}

bool UIsdkWidgetSubsystem::ShouldDebugDrawMoveEvents() const
{
  // TODO: drive this by a configuration
  return false;
}
