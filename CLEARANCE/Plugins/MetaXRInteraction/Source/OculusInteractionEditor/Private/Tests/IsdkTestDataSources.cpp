...
auto CreateOneEuroIsValidFn(const bool bExpected)
{
  return [bExpected](FAutomationTestBase* Test, const AIsdkTestDataSourcesActor& Actor)
  {
...
bool IsdkDataModifierInitOrderTests::RunTest(const FString& Parameters)
{
  ...
  auto CreateOneEuroHandFilter =
      [](FAutomationTestBase* Test, const AIsdkTestDataSourcesActor& Actor)
  {
    // Force creation.
  ...
  ADD_LATENT_AUTOMATION_COMMAND(
      FIsdkTestDataSourcesLambda(this, MoveTemp(CreateOneEuroHandFilter)));
  ...
  ADD_LATENT_AUTOMATION_COMMAND(
      FIsdkTestDataSourcesLambda(this, MoveTemp(CreateExternalHandDataSource)));
  ADD_LATENT_AUTOMATION_COMMAND(FWaitLatentCommand(isdk::test::OneFrameDelay));
