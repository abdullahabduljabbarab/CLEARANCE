...
public class OculusInteraction : ModuleRules
{
    public OculusInteraction(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        {
            RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/OculusInteractionLibrary/Lib/Mac/InteractionSdk.dylib");
        }
        else if (Target.Platform == UnrealTargetPlatform.Linux)
        {
            RuntimeDependencies.Add("$(PluginDir)/Source/ThirdParty/OculusInteractionLibrary/Lib/Linux/libInteractionSdk.so");
        }
