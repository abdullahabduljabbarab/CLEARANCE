...
{
  AIsdkTestGrabInteractorActor* const GrabInteractorActor = &AIsdkTestGrabInteractorActor::Get();
...
{
  AIsdkTestGrabInteractableActor* const GrabInteractableActor =
      &AIsdkTestGrabInteractableActor::Get();
...
bool FIsdkTestValidateHoverState::Update()
{
  ...
  UIsdkHandGrabDetector* const TestGrabDetector = GrabInteractorActor->GetHandGrabDetector();
...
bool FIsdkTestValidateGrabState::Update()
{
  ...
  UIsdkGrabberComponent* const TestGrabberComponent = GrabInteractorActor->GetGrabberComponent();
...
bool FIsdkTestValidateGrabbedObject::Update()
{
  ...
  const FString TestDescription =
      TEXT("Validate Grab States: Test Grabber is Grabbing Test Grabbable?");
