    ...
    UIsdkRigComponent* CallingRigComponent)
{
  ...
  const TMap<UObject*, FIsdkInteractorGroupMember> MemberMap =
      InteractionGroupRig->GetMemberInfoMap();
    ...
    const FIsdkInteractionPointerEvent& PointerEvent)
{
  ...
  const FTransform InteractorTransform = BoundPokeInteractor->GetComponentTransform();
