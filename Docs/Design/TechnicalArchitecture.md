...
For system behaviour, see the [Systems Design document](/Docs/Design/SystemsDesign.md). For enums, structs, and per-class API surfaces, see the [C++ Scaffold document](/Docs/Design/CppScaffold.md).
