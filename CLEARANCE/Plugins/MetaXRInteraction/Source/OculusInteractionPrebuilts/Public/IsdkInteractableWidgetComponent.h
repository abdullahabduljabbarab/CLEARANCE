...
#include "Interaction/IsdkPokeInteractable.h" // Needed for FIsdkPokeInteractableConfigOffsets
...
class OCULUSINTERACTIONPREBUILTS_API UIsdkInteractableWidgetComponent : public USceneComponent
{
 ...
 public:
  ...
  UFUNCTION(BlueprintGetter, Category = InteractionSDK)
  UIsdkRayInteractable* GetRayInteractable() const
  {
    return RayInteractable;
  }
  UFUNCTION(BlueprintGetter, Category = InteractionSDK)
  UIsdkPointableWidget* GetPointableWidget() const
  {
    return PointableWidget;
  }
  UFUNCTION(BlueprintGetter, Category = InteractionSDK)
  UIsdkWidgetEventAudioPlayer* GetWidgetEventAudioPlayer() const
  {
