...
USkinnedAsset* UIsdkHandPoseSubsystem::GetHandMesh(const EIsdkHandedness& Handedness)
{
...
FName UIsdkHandPoseSubsystem::GetActorClassNameFromComponent(USceneComponent* ComponentIn) const
{
...
bool UIsdkHandPoseSubsystem::RegisterHandPoseDetectionMultiple(
    UIsdkHandPoseDetectionProfile* ProfileIn,
    const TArray<UIsdkHandMeshComponent*>& HandMeshComponentsIn)
{
  bool bAllSuccess = true;
  for (UIsdkHandMeshComponent* ThisComponent : HandMeshComponentsIn)
  {
    bAllSuccess &= RegisterHandPoseDetection(ProfileIn, ThisComponent);
  }
