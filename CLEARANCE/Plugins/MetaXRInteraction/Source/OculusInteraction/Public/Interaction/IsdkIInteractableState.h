...
struct OCULUSINTERACTION_API FIsdkInteractableStateEvent
{
  ...
  {
    FIsdkInteractableStateChangeArgs StateChangeArgs;
    StateChangeArgs.PreviousState = PreviousState;
    StateChangeArgs.NewState = NewState;
    return FIsdkInteractableStateEvent{Interactable, MoveTemp(StateChangeArgs)};
  }
};
