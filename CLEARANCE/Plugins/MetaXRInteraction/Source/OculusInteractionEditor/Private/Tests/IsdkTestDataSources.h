...
class OCULUSINTERACTIONEDITOR_API AIsdkTestDataSourcesActor : public AActor
{
 ...
 public:
  ...
  {
    const auto Root = CreateDefaultSubobject<USceneComponent>(TEXT("Root"));
    SetRootComponent(Root);

    TestDataSourceExternal =
        CreateDefaultSubobject<UIsdkFakeHandDataSource>(TEXT("TestDataSourceExternal"));
    TestDataModifierOneEuro =
        CreateDefaultSubobject<UIsdkOneEuroFilterDataModifier>(TEXT("TestDataModifierOneEuro"));
  }
