...
class OCULUSINTERACTION_API UIsdkConditionalPoseOverride : public UIsdkConditional
{
 ...
 public:
  ...
  void SetRootOverride(const FTransform& RootOverride)
  {
   ...
   */
  UFUNCTION(BlueprintCallable, Category = InteractionSDK)
  bool GetRootOverride(FTransform& TransformOut) const
  {
   ...
   */
  UFUNCTION(BlueprintCallable, Category = InteractionSDK)
  void SetJointsOverride(const TArray<FTransform>& JointsOverride)
  {
   ...
   */
  UFUNCTION(BlueprintCallable, Category = InteractionSDK)
  bool GetJointsOverride(TArray<FTransform>& JointsOverriddenOut) const
  {
   ...
   */
  UFUNCTION(BlueprintCallable, Category = InteractionSDK)
  bool IsJointsOverrideActive() const
  {
   ...
   */
  UFUNCTION(BlueprintCallable, Category = InteractionSDK)
  bool IsRootOverrideActive() const
  {
