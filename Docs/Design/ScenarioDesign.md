...
For the runtime architecture behind the Scenario Runner, see the [Technical Architecture document](TechnicalArchitecture.md). For the systems the scenarios drive, see the [Systems Design document](SystemsDesign.md).
