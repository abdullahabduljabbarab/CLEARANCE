...
void UIsdkGrabInteractionRigComponent::InitializeComponent()
{
  ...
  const EIsdkHandedness ThisRigHandedness = RigComponent->GetHandedness();
    ...
    FActorComponentTickFunction* ThisTickFunction)
{
  ...
  const float PinchStrength = RigComponent->GetPinchStrength();
    ...
    FName AttachToComponentSocket)
{
  ...
  UIsdkConditional* const IsConnectedConditional =
