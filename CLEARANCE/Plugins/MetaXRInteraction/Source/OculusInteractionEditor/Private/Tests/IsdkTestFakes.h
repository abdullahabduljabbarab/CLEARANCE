                                ...
                                public IIsdkIHandPointerPose
{
 ...
 public:
  ...
  void SetHandJointsToPinchPose()
  {
    ...
    Poses.Reserve(26);
    Poses.Emplace(FRotator(0.0, 0.0, 0.0), FVector(-0.145789, 5.974506, 1.9), FVector::One());
    Poses.Emplace(FRotator(-0.091246, -0.045623, -90.0), FVector(0.0, 0.0, 0.0), FVector::One());
    // Thumb
    Poses.Emplace(
    ...
    Poses.Emplace(
        ...
        FVector::One());
    // Index
    Poses.Emplace(FRotator(0.0, 0.0, 0.0), FVector(2.004335, 3.77878, 0.284375), FVector::One());
    Poses.Emplace(
    ...
    Poses.Emplace(
        ...
        FVector::One());
    // Middle
    Poses.Emplace(FRotator(0.0, 0.0, 0.0), FVector(0.383252, 3.780457, -0.507344), FVector::One());
    Poses.Emplace(
    ...
    Poses.Emplace(
        ...
        FVector::One());
    // Ring
    Poses.Emplace(FRotator(0.0, 0.0, 0.0), FVector(-1.035655, 3.796854, -0.203718), FVector::One());
    Poses.Emplace(
    ...
    Poses.Emplace(
        ...
        FVector::One());
    HandData->GetJointPoses() = MoveTemp(Poses);
  ...
  void SetHandJointsToPalmGrabPose()
  {
    ...
    Poses.Reserve(26);
    Poses.Emplace(FRotator(0.0, 0.0, 0.0), FVector(-0.145789, 5.974506, 1.9), FVector::One());
    Poses.Emplace(FRotator(-0.091246, -0.045622, -90.0), FVector(0.0, 0.0, 0.0), FVector::One());
    // Thumb
    Poses.Emplace(
...
class UIsdkFakeTrackedDataSourceRigComponent : public UIsdkTrackedDataSourceRigComponent
{
 ...
 public:
  ...
  virtual void GetInteractorSocket(
      ...
      EIsdkInteractionType InteractionType) const override
  {
    OutSocketComponent = FakeMeshComponent.Get();
