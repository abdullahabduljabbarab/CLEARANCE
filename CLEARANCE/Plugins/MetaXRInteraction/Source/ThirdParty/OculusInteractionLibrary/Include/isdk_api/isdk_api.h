...
INTERACTIONSDK_EXPORT(void)
isdk_DigitRecognizer_update(isdk_DigitRecognizer* instance, float deltaTime, isdk_IHandPositionFrame* handPositionFrame);
...
INTERACTIONSDK_EXPORT(void)
isdk_FingerPinchGrabRecognizer_update(isdk_FingerPinchGrabRecognizer* instance, isdk_IHandPositionFrame* handPositionFrame);
