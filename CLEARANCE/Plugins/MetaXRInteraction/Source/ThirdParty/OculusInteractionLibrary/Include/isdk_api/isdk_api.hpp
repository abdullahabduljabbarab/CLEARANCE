...
class DigitRecognizer {
 public:
  ...
  void update(float deltaTime, isdk_IHandPositionFrame* handPositionFrame) {
    isdk_DigitRecognizer_update(getDigitRecognizerHandle(), deltaTime, handPositionFrame);
  }
...
class ActiveStateBool final : public IActiveState {
 public:
  ...
  [[nodiscard]] isdk_IActiveState* getIActiveStateHandle() const {
...
class FingerPinchGrabRecognizer final {
 public:
  ...
  static ObjectPtr<FingerPinchGrabRecognizer, isdk_FingerPinchGrabRecognizer> create(
    ...
    isdk_FingerPinchGrabRecognizer_create(fingerType, &retVal);
  ...
  void update(isdk_IHandPositionFrame* handPositionFrame) {
    isdk_FingerPinchGrabRecognizer_update(getFingerPinchGrabRecognizerHandle(), handPositionFrame);
  }
...
class FingerRecognizer final : public DigitRecognizer {
 public:
  ...
  static ObjectPtr<FingerRecognizer, isdk_FingerRecognizer> create(
    ...
    isdk_FingerRecognizer_create(parameters, fingerType, calcType, &retVal);
  ...
  [[nodiscard]] isdk_IDeltaTimeUpdate* getIDeltaTimeUpdateHandle() const {
...
class PalmGrabRecognizer final {
 public:
...
class ThumbRecognizer final : public DigitRecognizer {
 public:
  ...
  static ObjectPtr<ThumbRecognizer, isdk_ThumbRecognizer> create(
    ...
    isdk_ThumbRecognizer_create(parameters, calcType, &retVal);
