...
class OCULUSINTERACTIONPREBUILTS_API UIsdkRoundedButtonComponent : public USceneComponent
{
 ...
 protected:
  ...
  FLinearColor NormalColor = FLinearColor(1.0, 1.0, 1.0, 0.05);

  UPROPERTY(EditAnywhere, Category = InteractionSDK)
  FLinearColor HoverColor = FLinearColor(1.0, 1.0, 1.0, 0.3);

  UPROPERTY(EditAnywhere, Category = InteractionSDK)
  FLinearColor PressColor = FLinearColor(1.0, 1.0, 1.0, 0.5);

  UPROPERTY(EditAnywhere, Category = InteractionSDK)
  FLinearColor DisabledColor = FLinearColor(0.5, 0.5, 0.5, 1.0);
 ...
 private:
  ...
  UPROPERTY(
      ...
      Meta = (ExposeOnSpawn = true))
  FLinearColor BackplaneFillColor = FLinearColor(0.f, 0.f, 0.f, 0.05f);
  UPROPERTY(
      Category = "InteractionSDK|Material Props",
      EditAnywhere,
