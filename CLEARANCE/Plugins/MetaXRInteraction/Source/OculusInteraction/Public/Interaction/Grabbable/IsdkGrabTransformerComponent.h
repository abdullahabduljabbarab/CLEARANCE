...
class OCULUSINTERACTION_API UIsdkGrabTransformerComponent : public UActorComponent
{
 ...
 public:
   ...
   * of the Interactor*/
  void SetInteractorSnap(const FTransform& RelativeSnapPoint, float MoveSnapDuration = 0.f);
 ...
 private:
  ...
  void ExecuteInteractorSnap(const FTransform& RelativeSnapPoint, float MoveSnapDuration);
