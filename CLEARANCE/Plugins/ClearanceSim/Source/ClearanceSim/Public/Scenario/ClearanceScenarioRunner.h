...
private:
	...
	// Remembers the auto-spawner setting before the scenario started so it can be
	// restored on Stop(). Lets free-play resume cleanly after a scripted run. - TripleA
	bool bPrevAutoSpawn = true;
