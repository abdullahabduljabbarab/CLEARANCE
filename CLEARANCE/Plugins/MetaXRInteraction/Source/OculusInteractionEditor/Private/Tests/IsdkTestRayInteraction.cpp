...
{
  const UIsdkRayInteractor* TestRayInteractor =
      AIsdkTestRayInteractorActor::Get().GetTestRayInteractor();
  const EIsdkInteractorState CurrentState = TestRayInteractor->GetCurrentState();
...
{
  const UIsdkRayInteractable* TestRayInteractable =
      AIsdkTestRayInteractableActor::Get().TestRayInteractablePlane->GetInteractable();
  const EIsdkInteractableState CurrentState = TestRayInteractable->GetCurrentState();
  const FString TestDescription = FString::Printf(
...
{
  UIsdkRayInteractor* TestRayInteractor = AIsdkTestRayInteractorActor::Get().GetTestRayInteractor();
