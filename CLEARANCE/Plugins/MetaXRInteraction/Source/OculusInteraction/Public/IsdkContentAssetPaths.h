...
/**
 * @brief Provides static asset path constants for the OculusInteraction plugin.
 *
 * This class contains nested structs that organize asset paths by category,
 * including Configurations, Engine, Audio, Inputs, Materials, Models,
 * and ControllerDrivenHands. All paths are compile-time constants suitable
 * for use with Unreal Engine's asset loading systems.
 */
