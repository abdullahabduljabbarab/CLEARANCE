    ...
    bool& IsValid)
{
  ...
  if (IsValid)
  {
    PointerPose = IsdkXRUtils::OVR::ControllerRelativePointerTransform *
    ...
    bool& IsValid)
{
  ...
  if (IsValid)
  {
    PointerRelativePose = IsdkXRUtils::OVR::ControllerRelativePointerTransform;
  }
}

FTransform UIsdkFromMetaXRControllerDataSource::GetRootPose_Implementation()
{
  return IsdkXRUtils::OVR::ControllerRelativeRootTransform *
      MotionController->GetComponentTransform();
}
