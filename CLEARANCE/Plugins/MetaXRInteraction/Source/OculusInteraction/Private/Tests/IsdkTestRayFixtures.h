...
class OCULUSINTERACTION_API UIsdkTestRayFixture : public UObject
{
 ...
 public:
  ...
  void SetUp()
  {
    const ovrpPosef pointablePlaneOrigin{ovrpQuatf{0, 0, 0, 1}, ovrpVector3f{0, 0, 0}};
    const ovrpVector2f pointablePlaneSize{100.0f, 100.0f};
  ...
  static constexpr float MaxRayDistance_ = 1000.0f;
