...
class OCULUSINTERACTIONPREBUILTS_API UIsdkRayVisualComponent : public USceneComponent
{
 ...
 private:
  ...
  void UpdatePinchArrow(float InPinchStrength, const FTransform& PointerPoseTransform);
  void
  UpdateCursor(float InPinchStrength, const FTransform& CursorTransform, bool CollisionHitValid);
