...
For system behaviour, see the [Systems Design document](SystemsDesign.md). For enums, structs, and per-class API surfaces, see the [C++ Scaffold document](CppScaffold.md).
